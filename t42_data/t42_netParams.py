...
#print(">>> ¿Existe pvbc.hoc?:", os.path.exists('pvbc.hoc'))
...
if cfg.olmpopsize>0:
    ...
    netParams.importCellParams(label='OLM_rule', conds= {'cellType': 'OLM', 'cellModel': 'OLM'},
       	fileName = r'C:/Users/Usuario/Documents/LASCON_Project/olm.hoc', cellName='INT_cAC_noljp', somaAtOrigin=somator)
...
if cfg.pyrpopsize>0:
    netParams.importCellParams(label='PYR_rule', conds= {'cellType': 'PYR', 'cellModel': 'PYR'},
          	fileName=r'C:/Users/Usuario/Documents/LASCON_Project/pyr.hoc', cellName ='CA1_PC_cAC_sig', somaAtOrigin=somator)
